...
def getLicenseOverrides():
  ...
  with open(licenseOverridesCsvFile, 'w') as fd:
    fd.write('ApplicationPublicId,ApplicationId,PackageUrl,LicenseId,LicenseName\n')
    fd.close()
      ...
      if statusCode == 200:
        ...
        with open(licenseOverridesCsvFile, 'a') as fd:
          for component in components:
            ...
            licenseOverride = component["licenseData"]["effectiveLicenses"]
            licenseStr = ""

            for license in licenseOverride:
              licenseId = license["licenseId"]
              LicenseName = license["licenseName"]
              licenseStr = licenseId + ":" + LicenseName + ";"

            licenseStr = licenseStr[:-1]
            line = applicationName + "," + applicationId + "," + packageUrl + "," + licenseId + "," + LicenseName + "\n"
            fd.write(line)
